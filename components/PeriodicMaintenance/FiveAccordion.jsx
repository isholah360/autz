  ...
  const accordionData = [
    {
      ...
      content: {
        intro: "",
        items: ["Engine oil/ filter / gasket"],
      },
    },
    ...
    },
    {
      ...
      content: {
        ...
        items: [
          "Washer fluid",
          "Tires pressure",
          "Cooling system, hoeses & cooling level",
          "Cluth mechnaisms & fluid",
    ...
    },
    {
      ...
      content: {
        intro: "",
        items: ["Wheel nut torque as per SDS", "Body botts & nuts"],
      },
    },
    {
      title: "Lubricate",
